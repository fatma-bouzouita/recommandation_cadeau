...
class InterfaceEngine_6_11ans(InterfaceEngine):
    #fille------------------------------------------------------------------------------------------------------------------
    #anniversaire
    @Rule(Cadeau(age="6-11ans", sexe="feminine", interest="jeux_de_construction", occasion="anniversaire"))
    def fille_anniversaire_construction(self):
        self.declare(Resultat(result=("Pour une pré-adolescente aimant les jeux de construction, voici des idées de cadeaux pour son anniversaire : \n"
                                        "- Lego \n"
                                        "- Puzzles 3D\n"
    ...
    @Rule(Cadeau(age="6-11ans", sexe="feminine", interest="livres", occasion="anniversaire"))
    def fille_anniversaire_livre(self):
        self.declare(Resultat(result=("Pour une pré-adolescente aimant les livres, voici des idées de cadeaux pour son anniversaire : \n"
    ...
    @Rule(Cadeau(age="6-11ans", sexe="feminine", interest="sport", occasion="anniversaire"))
    def fille_anniversaire_sport(self):
        self.declare(Resultat(result=("Pour une pré-adolescente aimant le sport, voici des idées de cadeaux pour son anniversaire : \n"
    ...
    @Rule(Cadeau(age="6-11ans", sexe="feminine", interest="activités_artistiques", occasion="anniversaire"))
    def fille_anniversaire_art(self):
        self.declare(Resultat(result=("Pour une pré-adolescente aimant les activités artistiques, voici des idées de cadeaux pour son anniversaire : \n"
    ...
    #fille-------------------------------------------------------------------------------------------------------------------
    #Récompense scolaire
    @Rule(Cadeau(age="6-11ans", sexe="feminine", interest="jeux_de_construction", occasion="récompense_scolaire"))
    def fille_recompense_construction(self):
        self.declare(Resultat(result=("Pour une pré-adolescente aimant les jeux de construction, voici des idées de cadeaux comme une récompense scolaire : \n"
    ...
    @Rule(Cadeau(age="6-11ans", sexe="feminine", interest="livres", occasion="récompense_scolaire"))
    def fille_recompense_livre(self):
        self.declare(Resultat(result=("Pour une pré-adolescente aimant les livres, voici des idées de cadeaux comme une récompense scolaire : \n"
    ...
    @Rule(Cadeau(age="6-11ans", sexe="feminine", interest="sport", occasion="récompense_scolaire"))
    def fille_recompense_sport(self):
        self.declare(Resultat(result=("Pour une pré-adolescente aimant le sport, voici des idées de cadeaux comme une récompense scolaire : \n"
    ...
    @Rule(Cadeau(age="6-11ans", sexe="feminine", interest="activités_artistiques", occasion="récompense_scolaire"))
    def fille_recompense_art(self):
        self.declare(Resultat(result=("Pour une pré-adolescente aimant les activités artistiques, voici des idées de cadeaux comme une récompense scolaire : \n"
    ...
    #garcon------------------------------------------------------------------------------------------------------------------
    #anniversaire
    @Rule(Cadeau(age="6-11ans", sexe="masculin", interest="jeux_de_construction", occasion="anniversaire"))
    def garcon_anniversaire_construction(self):
        self.declare(Resultat(result=("Pour un pré-adolescent aimant les jeux de construction, voici des idées de cadeaux pour son anniversaire : \n"
    ...
    @Rule(Cadeau(age="6-11ans", sexe="masculin", interest="livres", occasion="anniversaire"))
    def garcon_anniversaire_livre(self):
        self.declare(Resultat(result=("Pour un pré-adolescent aimant les livres, voici des idées de cadeaux pour son anniversaire : \n"
    ...
    @Rule(Cadeau(age="6-11ans", sexe="masculin", interest="sport", occasion="anniversaire"))
    def garcon_anniversaire_sport(self):
        self.declare(Resultat(result=("Pour un pré-adolescent aimant le sport, voici des idées de cadeaux pour son anniversaire : \n"
    ...
    @Rule(Cadeau(age="6-11ans", sexe="masculin", interest="activités_artistiques", occasion="anniversaire"))
    def garcon_anniversaire_art(self):
        self.declare(Resultat(result=("Pour un pré-adolescent aimant les activités artistiques, voici des idées de cadeaux pour son anniversaire : \n"
    ...
    #garcon------------------------------------------------------------------------------------------------------------------
    #Récompense scolaire
    @Rule(Cadeau(age="6-11ans", sexe="masculin", interest="jeux_de_construction", occasion="récompense_scolaire"))
    def garcon_recompense_construction(self):
        self.declare(Resultat(result=("Pour un pré-adolescent aimant les jeux de construction, voici des idées de cadeaux comme une récompense scolaire : \n"
    ...
    @Rule(Cadeau(age="6-11ans", sexe="masculin", interest="livres", occasion="récompense_scolaire"))
    def garcon_recompense_livre(self):
        self.declare(Resultat(result=("Pour un pré-adolescent aimant les livres, voici des idées de cadeaux comme une récompense scolaire : \n"
                                        "- Un livre de science ludique pour enfants \n"
    ...
    @Rule(Cadeau(age="6-11ans", sexe="masculin", interest="sport", occasion="récompense_scolaire"))
    def garcon_recompense_sport(self):
        self.declare(Resultat(result=("Pour un pré-adolescent aimant le sport, voici des idées de cadeaux comme une récompense scolaire : \n"
                                        "- Des patins à roulettes ou un skateboard pour débutants \n"
    ...
    @Rule(Cadeau(age="6-11ans", sexe="masculin", interest="activités_artistiques", occasion="récompense_scolaire"))
    def garcon_recompense_art(self):
        self.declare(Resultat(result=("Pour un pré-adolescent aimant les activités artistiques, voici des idées de cadeaux comme une récompense scolaire : \n"
